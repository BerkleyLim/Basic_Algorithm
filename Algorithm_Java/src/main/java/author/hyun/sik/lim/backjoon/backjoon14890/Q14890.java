    ...
    public static void loadValue() {
        for (int n = 0;n < N;n++) {
            ...
            while (true) {
                ...
                if (mapLoad[n][s] == prev) s++;

                else {

                    if (mapLoad[n][s] == prev - 1) {        //감소
                        ...
                        for (int m = s;m <= s + L - 1;m++) {
                            ...
                            if (mapLoad[n][m] != mapLoad[n][s] || v[m]) { go = false; break; }
                        ...
                        for (int m = s - L;m < s;m++) {
                            ...
                            if (mapLoad[n][m] != mapLoad[n][s] - 1 || v[m]) { go = false; break; }
