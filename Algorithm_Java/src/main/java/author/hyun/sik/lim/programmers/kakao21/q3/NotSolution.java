...
public class NotSolution {
    ...
    // 직군 여부 - true : front-end, false : back-end
    private static String[] position;
    
    // 경력 구분 - true : junior, false : senior
    private static String[] career;
    
    // 선호하는 소울 푸드 - true : chicken, false : pizza
    ...
    public static int[] solution(String[] info, String[] query) {
        ...
        position = new String[info.length];
        ...
        for (int i = 0; i < query.length; i++) {
            ...
            for (int x = 0; x < length; x++) {
                // 직군
                if (string[2].equals("-")) {
                } else if (string[2].equals(position[arr[x]])) {
                } else {
                    continue;
                }
                ...
                // 경력
                if (string[4].equals("-")) {
                } else if (string[4].equals(career[arr[x]])) {
                } else {
                    continue;
                }
                ...
                // 푸드
                if (string[6].equals("-")) {
                } else if (string[6].equals(food[arr[x]])) {
                } else {
                    continue;
                }
